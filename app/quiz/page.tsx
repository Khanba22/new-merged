...
import { Check, X, Clock, Award, ArrowRight, RotateCcw, AlertCircle, BookOpen, Zap } from 'lucide-react';
...
export default function QuizPage() {
  ...
  const [answers, setAnswers] = useState<Array<{ question: number; selected: number; correct: boolean }>>([]);
  ...
  const handleTimeUp = () => {
    ...
    setAnswers([...answers, { question: current, selected: -1, correct: false }]);
  };
        ...
        <div className="w-full max-w-6xl flex flex-col">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-1">
                ...
                <span className="text-yellow-400 font-medium">{score * 120} points</span>
              </div>
          ...
          <Card className="w-full bg-purple-800 shadow-xl rounded-xl overflow-hidden border-none">
            <CardHeader className="bg-purple-700 text-white border-b border-purple-600">
              <CardTitle className="text-2xl font-bold text-center">Quiz Review: Tax Authorities</CardTitle>
            </CardHeader>
            <CardContent className="p-6 max-h-[70vh] overflow-y-auto bg-purple-800">
              <div className="space-y-6">
                {answers.map((answer, index) => (
                  <div key={index} className="border border-purple-600 rounded-lg p-4 bg-purple-700/50">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="mt-2 space-y-2">
                          {questions[answer.question].options.map((option, optIndex) => (
                            <div 
                              key={optIndex}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                {option.isCorrect && <Check className="h-4 w-4 text-green-400" />}
                                {!option.isCorrect && answer.selected === optIndex && <X className="h-4 w-4 text-red-400" />}
                              </div>
                            </div>
                          ))}
                          {answer.selected === -1 && (
                            <div className="p-3 rounded-md bg-yellow-900/20 border border-yellow-700">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-yellow-300">Time expired - no answer selected</span>
                              </div>
                            </div>
                          )}
                        </div>
          ...
          >
            <Card className="bg-purple-800 shadow-xl rounded-xl overflow-hidden border-none">
              <CardHeader className="bg-purple-700 text-white text-center p-8 border-b border-purple-600">
                ...
                <CardTitle className="text-3xl font-bold">Challenge Completed!</CardTitle>
              </CardHeader>
      ...
      <div className="w-full max-w-6xl flex flex-col">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            <Badge variant="outline" className="text-sm py-1.5 px-3 bg-purple-800 text-white border-purple-600">
              Section 3 of 3
            </Badge>
            <Badge variant="outline" className="text-sm py-1.5 px-3 bg-purple-800 text-white border-purple-600">
            ...
            <Card className="bg-purple-800 shadow-xl rounded-xl overflow-hidden border-none">
              <CardHeader className="bg-purple-700 text-white p-6 border-b border-purple-600">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-yellow-400 font-medium">Tax Fundamentals: Tax Authorities</span>
                </div>
                <CardTitle className="text-xl font-bold">{questions[current].question}</CardTitle>
              </CardHeader>
                          ...
                          ${selected === index && option.isCorrect 
                            ...
                            : selected === index 
                              ...
                              : selected !== null && option.isCorrect 
                                ? 'border-green-500 bg-green-900/20 text-white' 
                                : selected !== null ? 'border-purple-600 text-white' : ''
                          }
                        `}
                      >
                        <div className="flex-1">
